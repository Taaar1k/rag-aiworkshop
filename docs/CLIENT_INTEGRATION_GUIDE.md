...
- Python: `src/shared_rag/examples/python_example.py`
- JavaScript: `src/shared_rag/examples/js_example.js`
- LM Studio: `src/shared_rag/examples/lm_studio_example.py`
