...
**Files to modify:**
- [`src/core/memory_persistence.py`](src/core/memory_persistence.py)
...
**Files to modify:**
- [`config/default.yaml`](config/default.yaml) — `chunk_size: 768`
- [`src/core/memory_manager.py`](src/core/memory_manager.py:95) — text splitter config
...
- `src/api/rate_limiter.py` — new file
- `src/api/rag_server.py` — integrate limiter
...
**Files to modify:**
- `src/api/rag_server.py` — add scanner lifecycle
- `src/core/directory_scanner.py` — already exists
- `tests/test_directory_scanner.py` — add integration tests
...
**Files to create/modify:**
- `src/core/embedding_cache.py` — new file
- `config/default.yaml` — add cache config
...
**Files to modify:**
- `src/api/rag_server.py` — add health endpoints
...
**Files to modify:**
- `src/core/memory_manager.py` — ChromaDB client config
