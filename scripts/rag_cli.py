...
Works from any directory if RAG_ROOT env is set, or from the repo root.
"""
...
def get_rag_root() -> Path:
    ...
    # Try to find relative to this script (scripts/ sits next to src/)
    ...
    raise RuntimeError(
        "Cannot locate RAG root. Set RAG_ROOT env var or run from the repo root."
    )
