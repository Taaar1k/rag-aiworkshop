#!/usr/bin/env python3
"""
Test script for llama.cpp embedding model using llama-cpp-python.
Key: Must use embedding=True parameter for llama-cpp-python >= 0.2.80
"""
import sys
import os
...
def test_llama_cpp_embedding():
    ...
    try:
        ...
        print("=" * 60)
        print("Testing llama-cpp-python embedding API (CPU mode)")
        print("=" * 60)
