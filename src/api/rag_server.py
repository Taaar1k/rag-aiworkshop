"""
Shared RAG Server with FastAPI and ChromaDB.
...
app = FastAPI(
    ...
    description="OpenAI-compatible RAG server with ChromaDB vector storage",
    version="1.0.0",
    lifespan=lifespan,
)
...
async def chat_completions(request: Request, body: ChatCompletionRequest):
    ...
    Uses ChromaDB for vector search and LLM for response generation.
    """
    # Validate messages
